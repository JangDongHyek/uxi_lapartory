...
if($mode == "insert"){
	...
	if ($check > 0) {
		$skin_data = array("calm" => $prd_skin[0], "brightening" => $prd_skin[1], "moisturizing" => $prd_skin[2], "elasticity" => $prd_skin[3]);
		$skin = json_encode($skin_data);

	} else {
		$skin_data = array("calm" => 0, "brightening" => 0, "moisturizing" => 0, "elasticity" => 0);
		$skin = json_encode($skin_data);
	}
	// jangdh //
	...
	$sql = "insert into wiz_product
					...
					prdimg_L4,prdimg_M4,prdimg_S4,prdimg_L5,prdimg_M5,prdimg_S5,searchkey,stortexp,content,content_m,wdate,mdate,skin)
					...
					'$searchkey','$stortexp','$content','$content_m',now(),now(),'$skin')";
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	$sql = "update wiz_product set
	            ...
	            info_name5='$info_name5',info_value5='$info_value5',info_name6='$info_name6',info_value6='$info_value6',
							...
							searchkey='$searchkey',stortexp='$stortexp',content='$content',content_m='$content_m',mdate=now(),skin='$skin' where prdcode = '$prdcode'";
